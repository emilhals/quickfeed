...
type Score struct {
	...
	Secret        string                 `protobuf:"bytes,3,opt,name=Secret,proto3" json:"Secret,omitempty" gorm:"-" bun:"-"` // the unique identifier for a scoring session
...
const file_kit_score_score_proto_rawDesc = "" +
	"\n" +
	"\x15kit/score/score.proto\x12\x05score\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x0epatch/go.proto\"\xbf\x02\n" +
	"\x05Score\x12 \n" +
	...
	"\x06Secret\x18\x03 \x01(\tB\x17ʵ\x03\x13\xa2\x01\x10gorm:\"-\" bun:\"-\"R\x06Secret\x12\x1a\n" +
	...
	"\vTestDetails\x18\t \x01(\tR\vTestDetails\"\x88\x03\n" +
	"\tBuildInfo\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12?\n" +
