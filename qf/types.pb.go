...
type User struct {
	...
	ID               uint64                 `protobuf:"varint,1,opt,name=ID,proto3" json:"ID,omitempty" bun:",pk"`
...
type AssignmentFeedback struct {
	...
	ImprovementSuggestions string                 `protobuf:"bytes,5,opt,name=ImprovementSuggestions,proto3" json:"ImprovementSuggestions,omitempty"` // Required: What would make it better?
	TimeSpent              uint32                 `protobuf:"varint,6,opt,name=TimeSpent,proto3" json:"TimeSpent,omitempty"`                          // Required: Time used to complete the assignment
...
func (x *AssignmentFeedback) GetTimeSpent() uint32 {
	if x != nil {
		return x.TimeSpent
	}
	return 0
...
func (x *AssignmentFeedbacks) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_qf_types_proto_rawDesc = "" +
	"\n" +
	"\x0eqf/types.proto\x12\x02qf\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15kit/score/score.proto\x1a\x0epatch/go.proto\"\x89\x04\n" +
	"\x04User\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12\x18\n" +
	...
	"\x05Users\x12\x1e\n" +
	"\x05users\x18\x01 \x03(\v2\b.qf.UserR\x05users\"\xbe\x03\n" +
	"\x05Group\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x123\n" +
	...
	"\bAPPROVED\x10\x01\"+\n" +
	"\x06Groups\x12!\n" +
	"\x06groups\x18\x01 \x03(\v2\t.qf.GroupR\x06groups\"\xec\x05\n" +
	"\x06Course\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12(\n" +
	...
	".qf.CourseR\acourses\"\xbc\x04\n" +
	"\n" +
	"Repository\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12R\n" +
	...
	"\vEnrollments\x120\n" +
	"\venrollments\x18\x01 \x03(\v2\x0e.qf.EnrollmentR\venrollments\"\x98\x06\n" +
	"\n" +
	"Assignment\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12\x1a\n" +
	...
	"\rExpectedTests\x18\x0e \x03(\v2\f.qf.TestInfoB/ʵ\x03+\xa2\x01(bun:\"rel:has-many,join:id=assignment_id\"R\rExpectedTests\"\x82\x02\n" +
	"\bTestInfo\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12F\n" +
	...
	"\aDetails\x18\x06 \x01(\tR\aDetails\"\xd7\x01\n" +
	"\x04Task\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12\"\n" +
	...
	"\x06issues\x18\a \x03(\v2\t.qf.IssueR\x06issues\"\x8d\x01\n" +
	"\x05Issue\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12\"\n" +
	"\frepositoryID\x18\x02 \x01(\x04R\frepositoryID\x12\x16\n" +
	"\x06taskID\x18\x03 \x01(\x04R\x06taskID\x12&\n" +
	"\x0eScmIssueNumber\x18\x04 \x01(\x04R\x0eScmIssueNumber\"\xe8\x02\n" +
	"\vPullRequest\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12(\n" +
	...
	"\bAPPROVED\x10\x03\"?\n" +
	"\vAssignments\x120\n" +
	"\vassignments\x18\x01 \x03(\v2\x0e.qf.AssignmentR\vassignments\"\xcc\x05\n" +
	"\n" +
	"Submission\x12 \n" +
	"\x02ID\x18\x01 \x01(\x04B\x10ʵ\x03\f\xa2\x01\tbun:\",pk\"R\x02ID\x12\"\n" +
	...
	"\x06Status\x18\x03 \x01(\x0e2\x15.qf.Submission.StatusR\x06Status\"\xc4\x02\n" +
	...
	"\x06edited\x18\a \x01(\v2\x1a.google.protobuf.TimestampB0ʵ\x03,\xa2\x01)gorm:\"serializer:timestamp;type:datetime\"R\x06edited\"\xdc\x02\n" +
